...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const FIELDS = [
      ...
      { field: 'numImagesMax', spec: numberField('numImagesMax'), kind: 'number', labelKey: 'f.numImagesMax', hintKey: 'f.numImagesMaxHint', placeholderKey: 'p.numImagesMax' },
    ]
    ...
    const en = {
      'settings.title': 'FAL Image Generation (dsh-fal-image-gen)',
      'settings.description': 'generate_image tool backed by the FAL queue API (default model fal-ai/flux-2/klein/9b).',
      'settings.credentialHint': 'API key lives in Credentials under the reference set below (Settings → Credentials).',
      ...
      'f.model': 'Model',
      'f.modelHint': 'FAL model id, called as {baseURL}/{model}.',
      ...
      'f.outputDirHint': 'Relative to the workspace root; generated images are saved there too.',
      'f.numImagesMax': 'Max images per call',
      'f.numImagesMaxHint': 'Upper bound for the num_images tool parameter (1–4).',
      ...
      'p.outputDir': 'Example: generated/fal',
      'p.numImagesMax': 'Example: 4',
    }

    const ru = {
      'settings.title': 'FAL Image Generation (dsh-fal-image-gen)',
      'settings.description': 'Инструмент generate_image на базе FAL queue API (модель по умолчанию fal-ai/flux-2/klein/9b).',
      'settings.credentialHint': 'Ключ API хранится в Credentials под указанной ссылкой (Настройки → Credentials).',
      ...
      'f.model': 'Модель',
      'f.modelHint': 'ID модели FAL, вызывается как {baseURL}/{model}.',
      ...
      'f.outputDirHint': 'Относительно корня рабочей директории; туда тоже сохраняются картинки.',
      'f.numImagesMax': 'Макс. картинок за вызов',
      'f.numImagesMaxHint': 'Верхняя граница параметра num_images (1–4).',
      ...
      'p.outputDir': 'Пример: generated/fal',
      'p.numImagesMax': 'Пример: 4',
    }
    ...
    /** Вытащить вложение и подпись из блоков результата инструмента. */
