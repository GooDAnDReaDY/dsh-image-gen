...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const booleanField = (name) => ({ name, type: 'boolean', parse: (v) => v === 'true' || v === true, format: (v) => String(!!v) })
...
function FalImageCard(props) {
    ...
    function apply(ctx) {
      ...
      try {
        ...
        placedInPluginsTab = true
      } catch (noPluginItemSlot) {
        placedInPluginsTab = false
      }
      if (!placedInPluginsTab) {
