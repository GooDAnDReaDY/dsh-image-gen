  ...
  ctx.tools.register(
    defineTool({
      ...
      description:
        ...
        'session workspace (generated/fal/ by default) and displays it in the conversation. Use for any text-to-image request.',
      parameters: {
        prompt: {
          type: 'string',
          required: true,
      ...
      async execute(args, exec) {
        ...
        const outDir = path.resolve(sessionCwd || process.cwd(), config.outputDir)
