    ...
    defineTool({
      ...
      async execute(args, exec) {
        ...
        const providers = makeProviders(
          ...
          { prompt: args.prompt, size, format, seed: args.seed, signal: exec.signal, negativePrompt: args.negative_prompt, guidanceScale: args.guidance_scale, source, mask, strength: args.strength },
        )
