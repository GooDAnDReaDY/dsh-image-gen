  ...
  ctx.effect(() => {
    ...
    defineTool({
      ...
      async execute(args, exec) {
        ...
        const effectiveNegative = styleInfo.negativePrompt
        ...
        const providers = makeProviders(
          ...
          { prompt: effectivePrompt, size, format, seed: args.seed, signal: exec.signal, negativePrompt: effectiveNegative, guidanceScale: effectiveGuidance, source, mask, strength: args.strength, quality: args.quality, style: args.style, aspectPixels },
        )
        ...
        return { summary: dualOutputSummary, channel: provider, provider, model: cfg.model || cfg.customModel, ...first, images }
      },
    }),
  )
  ...
  ctx.tools.register(
    defineTool({
      ...
      async execute(args, exec) {
        ...
        return extractDesignTokens(colors, { prefix: args.prefix })
      },
    }),
  )
  ...
  ctx.tools.register(
    defineTool({
      ...
      async execute(args, exec) {
        ...
        return generateCssGradient(colors, args.type || 'mesh')
      },
    }),
  )
  ...
  ctx.tools.register(
    defineTool({
      ...
      async execute(args, exec) {
        ...
        return checkWcagContrast(colors, args.text_color || '#ffffff')
      },
    }),
  )
