    ...
    ctx.tools.register(
      defineTool({
        ...
        parameters: {
          ...
          frames: {
            type: 'number',
            description: 'Frame count: 4, 8, or 12 (default 8).',
          },
          frame_size: {
            type: 'string',
            description: 'Named size for each frame (default square_hd).',
          },
          duration: {
            type: 'number',
        ...
        async execute(args, exec) {
          try {
            ...
            const frameCount = clampFrames(args.frames)
            ...
            const size = args.frame_size || cfg.defaultSize || 'square_hd'
